...
HRESULT WarScene::init()
{
	...
	IMAGEMANAGER->addFrameImage("Ground", "resource/image/맵툴/maptoolGround.bmp", 0, 0, 320, 320, 5, 10, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("Mountin", "resource/image/맵툴/maptoolMountin.bmp", 0, 0, 320, 256, 5, 8, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("Water", "resource/image/맵툴/maptoolWater.bmp", 0, 0, 320, 192, 5, 6, true, RGB(255, 0, 255));
	IMAGEMANAGER->addFrameImage("Tree", "resource/image/맵툴/나무/treeFrmae.bmp", 0, 0, 960, 128, 6, 1, true, RGB(255, 0, 255));

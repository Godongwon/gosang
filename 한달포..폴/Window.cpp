...
void Window::init()
{
	...
	_selectWarMap= CreateWindow("button", "전투맵", WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON, tempX, 100, 100, 30, hWnd, HMENU(10), m_hInstance, NULL);
	_selectTwonMap= CreateWindow("button", "마을맵", WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON, tempX+115, 100, 100, 30, hWnd, HMENU(11), m_hInstance, NULL);
